  ...
  "Home": {
    ...
    "Image83": {
      "custom": {
        ...
        "src": "/app-assets/portfolio%20white%20bg.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image1": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-forward-arrow-25.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image20": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/2%20triangke.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image93": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product%20designer.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image97": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/white%20arr.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image44": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/person_n_desktop.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image114": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/testimonals.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image72": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/balck%20aee.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image124": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/lets%20get%20on%20a%20call.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
